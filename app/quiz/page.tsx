...
{ text: "The knowledge", branch: "B", scores: ["Martin", "Tess", "Harper", "Vaedin"] },
{ text: "The freedom of its citizens", branch: "C", scores: ["Jupiter", "Wisteria"] },
{ text: "The source of power itself", branch: "D", scores: ["Rhaymius", "Enna"] },
],
},
A: [
{
...
Enna: "She was willing to be moulded into whoever she needed to be, so long as the crown fit atop her head.",
Effie: "She enjoyed sunrises, specifically. The quiet warmth before the world fully woke. The feeling that everything was beginning again.",
...
Jupiter: "There was something sinful in the desperation of it. Something ugly and intoxicating in the way years of restrained longing unraveled between them all at once.",
Tess: "Her calming presence was more grounding than anything else ever could have been.",
Rhaymius: "There was a distant quality to him that made people feel small without him ever looking directly at them.",
Luc: "A true asset is never left in waiting.",
Vaedin: "Just Vaedin, Your Highness. I forsook my nobility to become a Keep scholar.",
Wisteria: "I won’t apologize for surviving.",
Martin: "Most healing isn’t blessed work. It’s patience.",
};

const descriptions: Record<string, string> = {
Enna: "Highly perceptive and endlessly strategic, Enna is always three steps ahead, piecing together truths others fail to see. Driven by ambition and a relentless curiosity, she trusts her mind above all else and refuses to accept the world at face value.",
Effie: "Compassionate, fiercely loyal, and endlessly hopeful, Effie carries the weight of her responsibilities without ever losing sight of the people she loves. Though duty often pulls her in one direction and her heart in another, she remains guided by kindness, friendship, and an unwavering belief that freedom is worth fighting for.",
Harper: "Warm, vibrant, and impossible to ignore, Harper embodies the color red: passionate, courageous, and full of life. Beneath her easy charm lies a deeply observant mind, one that finds beauty in stories, people, and the truths hidden between the lines.",
Hunter: "Reserved and enigmatic, Hunter possesses a quiet strength that draws others in without ever demanding attention. Deeply intelligent and endlessly curious, he finds meaning in ancient remedies, elemental magic, and the wisdom hidden within nature. Though gentle by nature, he will stop at nothing to protect the people he calls family.",
...
return ( <main className="min-h-screen bg-[#fff8f3] px-6 py-24 text-center text-[#3b071d]"> <div className="mx-auto max-w-2xl rounded-3xl bg-[#f7e8ea] p-10 shadow-2xl"> <p className="text-sm uppercase tracking-[0.35em] text-[#8b6f3d]">
Newsletter Exclusive </p>
...
return (
  <main
    ...
    style={{ background: `linear-gradient(to bottom, ${style.bg}, #fffdf8)` }}
  >
    <div className="mx-auto max-w-5xl py-12 text-center">
      ...
      <p className="mt-4 text-xl italic md:text-2xl" style={{ color: style.color }}>
        {titles[result]}
      </p>
...
return ( <main className="min-h-screen bg-[#fff8f3] px-6 py-24 text-[#3b071d]"> <div className="mx-auto max-w-4xl py-10 text-center"> <p className="text-sm uppercase tracking-[0.35em] text-[#8b6f3d]">
Character Quiz </p>
